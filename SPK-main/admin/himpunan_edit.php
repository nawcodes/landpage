...
<!-- Body -->
		...
		<!-- Page title -->
			...
			$query=mysqli_query($conn,"select * from himpunan where id_himpunan='$id_himpunan'");
			...
			<input type=hidden name='id_himpunan' value=<?php echo $_GET['id_himpunan']; ?> >
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">Nilai Kriteria:</label>
							<div class="col-sm-10">
			...
			if (isset($_POST['ubah'])) {
				...
				$query=mysqli_query($conn,"UPDATE himpunan SET id_kriteria='$id_kriteria', namahimpunan='$namahimpunan', nilai='$nilai', keterangan='$keterangan' WHERE id_himpunan='$id_himpunan'") or die(mysqli_connect_error());
				if ($query) {
